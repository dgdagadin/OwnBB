...
$ForumLang['ForgotPassLogin'] = 'Введите ваш логин';
$ForumLang['ForgotPassMail'] = 'Введите электронную почту';
$ForumLang['ForgotPassMailNotice'] = 'Укажите электронную почту, указанную в Вашем профиле';
$ForumLang['ForgotPassSubmit'] = 'Восстановить пароль';
