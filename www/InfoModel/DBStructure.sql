...
INSERT INTO charters (CharterID, CharterName, CharterPosition) VALUES ('1', 'Новости и описания OwnBB', '1');
INSERT INTO charters (CharterID, CharterName, CharterPosition) VALUES ('2', 'Разработка OwnBB', '2');
INSERT INTO charters (CharterID, CharterName, CharterPosition) VALUES ('3', 'Демо-категория', '3');
INSERT INTO charters (CharterID, CharterName, CharterPosition) VALUES ('4', 'Прочее', '4');
-------------------------------
...
INSERT INTO forums_list (ForumName, ForumDescription, ForumPosition, ForumNumThemes, ForumNumPosts, ForumGuestView, ForumMinStatus, ForumLastThemeID, ForumLastPostID, ForumLastUserID, ForumLastUserName, ForumLastUpDate, ForumBlock, CharterID) VALUES ('Описание',   'Раздел посвящен описанию движка OwnBB',   '1', '0', '0', 'yes', NULL, NULL, NULL, NULL, NULL, NULL, 'yes', '1');
INSERT INTO forums_list (ForumName, ForumDescription, ForumPosition, ForumNumThemes, ForumNumPosts, ForumGuestView, ForumMinStatus, ForumLastThemeID, ForumLastPostID, ForumLastUserID, ForumLastUserName, ForumLastUpDate, ForumBlock, CharterID) VALUES ('Новости',   'В этом разделе публикуются новости движка и их обсуждение',   '2', '0', '0', 'yes', NULL, NULL, NULL, NULL, NULL, NULL, 'yes', '1');
INSERT INTO forums_list (ForumName, ForumDescription, ForumPosition, ForumNumThemes, ForumNumPosts, ForumGuestView, ForumMinStatus, ForumLastThemeID, ForumLastPostID, ForumLastUserID, ForumLastUserName, ForumLastUpDate, ForumBlock, CharterID) VALUES ('Релизы',   'В этом разделе выкладываются новые релизы форума',   '3', '0', '0', 'yes', NULL, NULL, NULL, NULL, NULL, NULL, 'yes', '1');
INSERT INTO forums_list (ForumName, ForumDescription, ForumPosition, ForumNumThemes, ForumNumPosts, ForumGuestView, ForumMinStatus, ForumLastThemeID, ForumLastPostID, ForumLastUserID, ForumLastUserName, ForumLastUpDate, ForumBlock, CharterID) VALUES ('Общее',   'Общие вопросы по разработке движка',   '4', '0', '0', 'yes', NULL, NULL, NULL, NULL, NULL, NULL, 'yes', '2');
INSERT INTO forums_list (ForumName, ForumDescription, ForumPosition, ForumNumThemes, ForumNumPosts, ForumGuestView, ForumMinStatus, ForumLastThemeID, ForumLastPostID, ForumLastUserID, ForumLastUserName, ForumLastUpDate, ForumBlock, CharterID) VALUES ('Предложения',   'Тут выдвигаются различные предложения, замечания, пожелания и т.п. по форуму',   '5', '0', '0', 'yes', NULL, NULL, NULL, NULL, NULL, NULL, 'yes', '2');
INSERT INTO forums_list (ForumName, ForumDescription, ForumPosition, ForumNumThemes, ForumNumPosts, ForumGuestView, ForumMinStatus, ForumLastThemeID, ForumLastPostID, ForumLastUserID, ForumLastUserName, ForumLastUpDate, ForumBlock, CharterID) VALUES ('Ошибки',   'Тут выкладываются найденные в движке ошибки',   '6', '0', '0', 'yes', NULL, NULL, NULL, NULL, NULL, NULL, 'yes', '2');
INSERT INTO forums_list (ForumName, ForumDescription, ForumPosition, ForumNumThemes, ForumNumPosts, ForumGuestView, ForumMinStatus, ForumLastThemeID, ForumLastPostID, ForumLastUserID, ForumLastUserName, ForumLastUpDate, ForumBlock, CharterID) VALUES ('Тест',   'Просто тестовый раздел',   '7', '0', '0', 'yes', NULL, NULL, NULL, NULL, NULL, NULL, 'yes', '3');
INSERT INTO forums_list (ForumName, ForumDescription, ForumPosition, ForumNumThemes, ForumNumPosts, ForumGuestView, ForumMinStatus, ForumLastThemeID, ForumLastPostID, ForumLastUserID, ForumLastUserName, ForumLastUpDate, ForumBlock, CharterID) VALUES ('Закрытый',   'Пример закрытого форума',   '8', '0', '0', 'yes', NULL, NULL, NULL, NULL, NULL, NULL, 'yes', '3');
INSERT INTO forums_list (ForumName, ForumDescription, ForumPosition, ForumNumThemes, ForumNumPosts, ForumGuestView, ForumMinStatus, ForumLastThemeID, ForumLastPostID, ForumLastUserID, ForumLastUserName, ForumLastUpDate, ForumBlock, CharterID) VALUES ('Ограниченный',   'Пример форумаб доступного только администраторам',   '9', '0', '0', 'yes', NULL, NULL, NULL, NULL, NULL, NULL, 'yes', '3');
INSERT INTO forums_list (ForumName, ForumDescription, ForumPosition, ForumNumThemes, ForumNumPosts, ForumGuestView, ForumMinStatus, ForumLastThemeID, ForumLastPostID, ForumLastUserID, ForumLastUserName, ForumLastUpDate, ForumBlock, CharterID) VALUES ('Философствования',   'Тут можно пофилософствовать за жизнь',   '10', '0', '0', 'yes', NULL, NULL, NULL, NULL, NULL, NULL, 'yes', '4');
INSERT INTO forums_list (ForumName, ForumDescription, ForumPosition, ForumNumThemes, ForumNumPosts, ForumGuestView, ForumMinStatus, ForumLastThemeID, ForumLastPostID, ForumLastUserID, ForumLastUserName, ForumLastUpDate, ForumBlock, CharterID) VALUES ('Мусорка',   'То, что не подошло к другим форумам',   '11', '0', '0', 'yes', NULL, NULL, NULL, NULL, NULL, NULL, 'yes', '4');
-------------------------------
