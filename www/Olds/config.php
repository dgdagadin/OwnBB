...
$Config_ForumName = 'Просто форум';//Название форума
...
//Пути
define ('OBB_ROOT_DIR', 'large_forum'); //Корневая директория форума
...
define ('OBB_NUM_IP_OCTETS', 3); //количество разрядов ИП, проверяемых при авторизации
define ('OBB_NUM_THEMES_PER_PAGE', 20); //количество тем на страницу
define ('OBB_NUM_POSTS_PER_PAGE', 30); //количество постов (сообщений) на страницу
...
define ('OBB_NUM_POSTS_FOR_POP_THEME', 50); //количество постов в теме для превращения ее в популярную
define ('OBB_MAX_AVATAR_SIZE', 37888); //Максимальный размер аватара (Байт)
define ('OBB_MAX_AVATAR_WIDTH', 160); //Максимальная ширина аватара
define ('OBB_MAX_AVATAR_HEIGHT', 160); //Максимальная высота аватара
define ('OBB_MAX_ATTACH_SIZE', 37888); //Максимальный размер загружаемого (Байт)
...
define ('OBB_MAX_SEARCH_WORD', 30); //Максимальная длина слова поиска
...
define ('OBB_SHOW_YOUR_ABILITIES', TRUE); //Выводить ли краткое описание возможностей пользователя на главной странице
...
//define ('OBB_REGISTRATION_CAPTCHA', TRUE); //выводить ли капчу при регистрации
//define ('OBB_ADD_USER_CAPTCHA', false); //Выводить ли капчу всем при добавлении темы/поста
//define ('OBB_ADD_GUEST_CAPTCHA', TRUE); //Выводить ли капчу гостю при добавлении
//define ('OBB_GUEST_WATCH_PROFILE', TRUE); //Возможность гостям просматривать профили пользователей
//define ('OBB_GUEST_WATCH_MAIN_PAGE', TRUE); //Можно ли гостю на главную страницу
//define ('OBB_GUEST_VIEW_MAIN_STATISTICS', TRUE); //Можно ли гостю выводить основную статистику на главной странице
//define ('OBB_GUEST_VIEW_ONLINE_STATISTICS', TRUE); //Можно ли гостю выводить статистику онлайн на главной странице
//define ('OBB_GUEST_ADD_ATTACH', TRUE); //Можно ли гостю присоединять файлы
//define ('OBB_COMMON_ADD_ATTACH', TRUE); //Можно ли вообще аттачить файлы
//define ('OBB_GUEST_DOWNLOAD_ATTACH', TRUE); //Можно ли гостю скачивать файлы
//define ('OBB_GUEST_WATCH_THEMES', TRUE); //Можно ли гостю просматривать темы всех форумов
//define ('OBB_GUEST_ADD_THEMES', TRUE); //Можно ли гостю создавать темы
//define ('OBB_GUEST_WATCH_POSTS', TRUE); //Можно ли гостю просматривать сообщения всех тем
//define ('OBB_GUEST_ADD_POSTS', TRUE); //Можно ли гостю оставлять посты
//define ('OBB_USER_EDIT_POSTS', TRUE); //Можно ли править посты

//define ('OBB_GUEST_WATCH_USER_LIST', TRUE); //Разрешать ли гостю просматривать список пользователей
define ('OBB_SEARCH_ENABLED', TRUE); //Разрешен ли поиск по форуму
define ('OBB_GUEST_SEARCH', TRUE); //Разрешен ли поиск по форуму гостю
...
define ('OBB_GET_MESSAGE_CACHE', TRUE); //Разрешено ли брать сообщения из кэша при выводе
define ('OBB_BB_PARSE_ALLOWED', TRUE); //Разрешен ли парсинг bb-кодов сообщений при выводе
//define ('OBB_REPORT_CAPTCHA', TRUE); //Выводить ли капчу при жалобе на сообщение
define ('OBB_SEARCH_HIGHLIGHT', TRUE); //Разрешена ли подсветка искомой фразы в поиске по форуму
define ('OBB_GET_SEARCH_MESSAGE_CACHE', TRUE); //Разрешено ли брать из кэша посты при поиске
define ('OBB_BB_SEARCH_PARSE_ALLOWED', TRUE); //Разрешено ли парсить посты при поиске
//define ('OBB_MAIL_CAPTCHA', TRUE); //выводить ли капчу при отправке письма
...
//Настройки капчи
 define ('OBB_CAPTCHA_WIDTH', 175);//ширина капчи
 ...
 define ('OBB_CAPTCHA_NUM_DOTS', 45);//к-во точек на фоне
 define ('OBB_CAPTCHA_NUM_LINES', 25);//к-во линий на фоне
 define ('OBB_CAPTCHA_NUM_LETTERS', 4);//к-во основных символов
